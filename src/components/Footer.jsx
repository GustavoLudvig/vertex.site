...
const Footer = () => {
  return (
    <footer className="bg-[#0a0a0a] border-t border-[#C9A84C]/20 py-12" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center md:text-right">
            <div className="flex justify-center md:justify-end space-x-4">
              <a
                href="#"
                className="text-[#B0B0B0] hover:text-[#C9A84C] transition-colors"
        ...
        <div className="border-t border-[#C9A84C]/20 mt-8 pt-8 text-center">
          <p className="text-[#B0B0B0] text-sm">
            © 2025 Vertex Estratégia Digital. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
