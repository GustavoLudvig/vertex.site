...
const SEGMENTS = [
  {
    ...
    slots: [
      {
        video: '/case-hospedagem-morada.mp4',
        site: 'https://www.moradadoscanyons.com/',
        label: 'Morada dos Canyons',
      },
      null,
      null,
      null,
    ...
    <TiltedCard maxTilt={8} scale={1.04} glow={`${segment.accent}40`} className="rounded-2xl">
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="border-t border-white/10 px-3 py-2.5 flex items-center justify-between gap-2 text-vertex-gold hover:bg-vertex-gold hover:text-vertex-black transition-colors"
        >
          <span className="flex items-center gap-1.5 min-w-0">
            <Globe size={12} className="flex-shrink-0" />
            <span className="text-[10px] font-semibold truncate">
              {slot.site.replace(/^https?:\/\/(www\.)?/, '').replace(/\/$/, '')}
            </span>
          </span>
          <span className="text-[9px] uppercase tracking-widest font-bold flex items-center gap-1 flex-shrink-0">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16 md:mb-24">
              ...
              <div className="order-1 lg:order-2 text-center lg:text-left">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-7 py-4 rounded-full bg-[#25D366] text-white text-sm font-bold uppercase tracking-wider hover:bg-[#20bd5a] transition-colors animate-pulse-green"
                >
                  <WhatsAppGlyph />
